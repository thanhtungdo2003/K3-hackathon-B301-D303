...
export default function JoinPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full flex-col px-4 py-6 max-w-4xl">
      ...
      <form onSubmit={submit} className="flex flex-1 justify-center flex-col gap-6">
              ...
              <div className="flex gap-2">
                <BlockInput
                  ...
                  onChange={(e) => {
                    ...
                    localStorage.setItem("learner_name", e.target.value);
                  }}
